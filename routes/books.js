...
router.post('/', auth, multer.upload.single("image"), /*sharp,*/ booksControle.createBook);
router.get('/:id', booksControle.getOneBook);
router.put('/:id', auth, multer.upload.single("image"), /*sharp,*/ booksControle.modifyBook);
